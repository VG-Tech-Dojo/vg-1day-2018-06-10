...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2018-06-10/nakata/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2018-06-10/nakata/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2018-06-10/nakata/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	btcBot := bot.NewBtcBot(s.poster.In)
	s.bots = append(s.bots, btcBot)
	spreadBot := bot.NewSpreadBot(s.poster.In)
	s.bots = append(s.bots, spreadBot)

	hatenaBot := bot.NewHatenaBot(s.poster.In)
	s.bots = append(s.bots, hatenaBot)
