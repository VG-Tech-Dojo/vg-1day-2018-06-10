...
import (
	...
	"github.com/VG-Tech-Dojo/vg-1day-2018-06-10/team_C/bot"
	"github.com/VG-Tech-Dojo/vg-1day-2018-06-10/team_C/controller"
	"github.com/VG-Tech-Dojo/vg-1day-2018-06-10/team_C/db"
...
func (s *Server) Init(dbconf, env string) error {
	...
	diceBot := bot.NewDiceBot(s.poster.In)
	s.bots = append(s.bots, diceBot)
